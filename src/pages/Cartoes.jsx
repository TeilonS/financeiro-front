                  ...
                  <div className="flex gap-1">
                    {deletandoId === c.id ? (
                      <div className="flex items-center gap-1">
                        ...
                        <button onClick={() => setDeletandoId(null)} className="text-xs bg-zinc-200 dark:bg-zinc-800 hover:bg-zinc-300 dark:hover:bg-zinc-700 text-zinc-700 dark:text-zinc-300 px-2 py-1 rounded-lg">Não</button>
                      </div>
                    ) : (
                      <>
