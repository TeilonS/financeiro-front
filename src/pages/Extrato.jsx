          ...
          <div className="mt-5 space-y-3">
            <div className="bg-zinc-800 dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-800 rounded-xl px-4 py-3 text-sm flex flex-wrap gap-4">
              <span className="text-zinc-700 dark:text-zinc-300">
                <strong className="text-zinc-500 dark:text-zinc-900 dark:text-white">{uploadResult.totalTransacoes}</strong> transações importadas
              </span>
      ...
      {selecionados.length > 0 && (
        <div className="bg-primary-50 dark:bg-primary-900/20 border border-primary-200 dark:border-primary-800 rounded-2xl p-4 mb-4 flex flex-wrap items-center gap-3">
          ...
          <select
            ...
            className="flex-1 min-w-[180px] px-3 py-1.5 border border-primary-200 dark:border-primary-700 rounded-xl text-sm bg-zinc-800 dark:text-zinc-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-primary-500/40 focus:border-primary-500">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-4 py-2.5 border border-zinc-300 dark:border-zinc-700 rounded-xl text-sm bg-zinc-800 dark:text-zinc-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-primary-500/40 focus:border-primary-500">
