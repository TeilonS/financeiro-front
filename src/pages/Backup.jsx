...
export default function Backup() {
  ...
  return (
    <div className="p-6 max-w-2xl mx-auto">
      <div className="mb-6">
        <h1 className="font-display text-xl font-semibold text-zinc-900 dark:text-zinc-900 dark:text-white">Backup</h1>
        <p className="text-zinc-400 dark:text-zinc-500 text-sm mt-0.5">Exporte ou restaure todos os seus dados</p>
      </div>
      ...
      <div className="space-y-4">
        {/* Exportar */}
        <div className="bg-white dark:bg-white dark:bg-zinc-900 shadow-sm border border-zinc-100 dark:border-zinc-100 dark:border-zinc-800 rounded-2xl border border-zinc-200 dark:border-zinc-100 dark:border-zinc-800 shadow-sm p-6">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              <button onClick={handleExportar} disabled={exportLoading}
                className="bg-primary-600 hover:bg-primary-700 text-zinc-900 dark:text-zinc-900 dark:text-white px-5 py-2 rounded-xl text-sm font-medium transition-colors disabled:opacity-60 flex items-center gap-2">
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              <button onClick={() => fileInputRef.current?.click()} disabled={importLoading}
                className="bg-amber-500 hover:bg-amber-600 text-zinc-900 dark:text-zinc-900 dark:text-white px-5 py-2 rounded-xl text-sm font-medium transition-colors disabled:opacity-60 flex items-center gap-2">
        ...
        {/* Info */}
        <div className="bg-zinc-800 dark:bg-zinc-800 rounded-2xl border border-zinc-200 dark:border-zinc-100 dark:border-zinc-800 p-5">
          <div className="flex items-center gap-2 mb-3">
            <HardDrive size={16} className="text-zinc-400 dark:text-zinc-500" />
            <span className="text-sm font-medium text-zinc-700 dark:text-zinc-300">O que é incluído no backup</span>
          </div>
          <ul className="space-y-1.5 text-xs text-zinc-400 dark:text-zinc-500">
