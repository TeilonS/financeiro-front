    ...
    <div className={`bg-white dark:bg-zinc-900 shadow-sm border border-zinc-100 dark:border-zinc-800 rounded-xl border border-zinc-200 dark:border-zinc-800 p-4 flex items-center justify-between group ${isRoot ? '' : 'py-3'}`}>
      ...
      {deletandoId === cat.id ? (
        <div className="flex items-center gap-1.5">
          ...
          <button onClick={() => setDeletandoId(null)} className="text-xs text-zinc-700 dark:text-zinc-300 bg-zinc-200 dark:bg-zinc-800 hover:bg-zinc-300 dark:hover:bg-zinc-700 px-2 py-1 rounded-lg">Não</button>
        </div>
      ) : (
